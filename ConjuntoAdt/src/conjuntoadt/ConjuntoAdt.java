...
public class ConjuntoAdt {
    ...
    public static void main(String[] args) {
       ...
       Scanner leer = new Scanner(System.in);
        ...
        System.out.println("Ingresa los datos para el conjuto A:");
        int tA = leer.nextInt();
         System.out.println("Ingresa los datos para el conjuto b:");
        int tB = leer.nextInt();
        
        int []A= new int [tA];
          int []B= new int [tB];
          System.out.println("Ingresa los elementos para el Conjunto A");
